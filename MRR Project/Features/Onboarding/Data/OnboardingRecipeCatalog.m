...
static OnboardingRecipeDetail *MRRDetail(NSString *title, NSString *subtitle, NSString *assetName, NSString *durationText, NSString *calorieText,
                                         NSString *servingsText, NSString *summaryText, NSArray<NSString *> *ingredients,
...
static OnboardingRecipeDetail *MRRDetailWithMetadata(NSString *title, NSString *subtitle, NSString *assetName, NSString *durationText,
                                                     NSString *calorieText, NSString *servingsText, NSString *summaryText,
                                                     NSArray<NSString *> *ingredients, NSArray<OnboardingRecipeInstruction *> *instructions,
                                                     NSArray<NSString *> *tools, NSArray<NSString *> *tags) {
  return [[[OnboardingRecipeDetail alloc] initWithTitle:title
                                               subtitle:subtitle
                                              assetName:assetName
                                     heroImageURLString:nil
...
static OnboardingRecipePreview *MRRPreview(NSString *title, NSString *subtitle, NSString *assetName, NSString *openFoodFactsBarcode,
...
- (NSArray<OnboardingRecipePreview *> *)allRecipePreviews {
  return @[
    MRRPreview(
        @"Avocado Toast", @"Bright breakfast", @"avocado-toast", nil,
        MRRDetailWithMetadata(@"Avocado Toast", @"Bright breakfast", @"avocado-toast", @"10 min", @"280 kcal", @"2 servings",
                              ...
                              @[ @"Chef knife", @"Mixing bowl", @"Toaster or skillet" ], @[ @"Breakfast", @"Quick", @"Vegetarian" ])),
    MRRPreview(@"Seared Salmon", @"Fast weeknight dinner", @"salmon", nil,
               MRRDetail(@"Seared Salmon", @"Fast weeknight dinner", @"salmon", @"18 min", @"430 kcal", @"2 servings",
    ...
    MRRPreview(@"Pasta Carbonara", @"Silky comfort bowl", @"pasta-carbonara", nil,
               MRRDetail(@"Pasta Carbonara", @"Silky comfort bowl", @"pasta-carbonara", @"25 min", @"520 kcal", @"3 servings",
    ...
    MRRPreview(@"Greek Salad", @"Crunchy midday plate", @"greek-salad", nil,
               MRRDetail(@"Greek Salad", @"Crunchy midday plate", @"greek-salad", @"12 min", @"240 kcal", @"2 servings",
    ...
    MRRPreview(@"Green Curry", @"Aromatic comfort", @"green-curry", nil,
               MRRDetail(@"Green Curry", @"Aromatic comfort", @"green-curry", @"30 min", @"470 kcal", @"3 servings",
    ...
    MRRPreview(@"Ramen Bowl", @"Cozy late-night pick", @"ramen", nil,
               MRRDetail(@"Ramen Bowl", @"Cozy late-night pick", @"ramen", @"22 min", @"560 kcal", @"2 servings",
    ...
    MRRPreview(@"Pizza Night", @"Crowd-pleasing classic", @"pizza", nil,
               MRRDetail(@"Pizza Night", @"Crowd-pleasing classic", @"pizza", @"35 min", @"610 kcal", @"4 servings",
    ...
    MRRPreview(
        @"Beef Bourguignon", @"Slow-cooked showpiece", @"beef-bourguignon", nil,
        MRRDetail(@"Beef Bourguignon", @"Slow-cooked showpiece", @"beef-bourguignon", @"45 min", @"650 kcal", @"4 servings",
